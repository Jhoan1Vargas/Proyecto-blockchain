...
const { insertarUsuario } = require("../models/usuarioModel")
const { guardarWalletIdUsuario } = require("../models/walletModel")
const { mnemonic } = require('../secrets.json');

const cuentasPrivadas = [
...
async function crearUsuarioBanco(){
  await insertarUsuario("Banco","1","banco@prueba.com",1,"A")
}
